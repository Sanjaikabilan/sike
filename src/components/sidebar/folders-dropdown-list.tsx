...
const FoldersDropDownList: React.FC<FoldersDropDownListProps> = ({
  ...
  return (
    <>
      <div
        className=" flex sticky z-20 top-0 bg-background w-full 
      h-10 group/title justify-between items-center pr-4 text-Neutrals/neutrals-8"
      >
        ...
        <TooltipComponent message="Create Folder">
          <PlusIcon
            ...
            cursor-pointer hover:dark:text-white"
          />
        </TooltipComponent>
      </div>
      <Accordion
